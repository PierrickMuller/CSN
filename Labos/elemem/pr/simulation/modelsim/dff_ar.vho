...
SIGNAL \Qfut_s~0_combout\ : std_logic;
SIGNAL \reset_i~input_o\ : std_logic;
SIGNAL \Q_s~q\ : std_logic;
...
\Qfut_s~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \Qfut_s~0_combout\ = (!\R_i~input_o\ & ((\Q_s~q\) # (\S_i~input_o\)))
