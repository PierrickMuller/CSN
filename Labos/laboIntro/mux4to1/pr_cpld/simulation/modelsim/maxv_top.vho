...
-- Equation(s):
-- \U1|Mux0~0_combout\ = (\Switch_i~combout\(0) & (((\Switch_i~combout\(1))) # (!\nButton_i~combout\(2)))) # (!\Switch_i~combout\(0) & (((!\Switch_i~combout\(1) & !\nButton_i~combout\(1)))))
...
\U1|Mux0~1\ : maxv_lcell
-- Equation(s):
-- \U1|Mux0~1_combout\ = (\Switch_i~combout\(1) & ((\U1|Mux0~0_combout\ & (!\nButton_i~combout\(4))) # (!\U1|Mux0~0_combout\ & ((!\nButton_i~combout\(3)))))) # (!\Switch_i~combout\(1) & (\U1|Mux0~0_combout\))
...
-- pragma translate_on
PORT MAP (
	datain => \U1|ALT_INV_Mux0~1_combout\,
	oe => VCC,
	padio => ww_nLed_o(0));
