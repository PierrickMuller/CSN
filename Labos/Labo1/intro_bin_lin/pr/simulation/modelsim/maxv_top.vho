...
\U1|LessThan6~0\ : maxv_lcell
-- Equation(s):
-- \U1|LessThan6~0_combout\ = (((!\nButton_i~combout\(2) & !\nButton_i~combout\(3))))
...
\U1|LessThan7~0\ : maxv_lcell
-- Equation(s):
-- \U1|LessThan7~0_combout\ = ((\nButton_i~combout\(1)) # ((\nButton_i~combout\(2)) # (\nButton_i~combout\(3))))
...
-- pragma translate_on
PORT MAP (
	datain => \U1|ALT_INV_LessThan6~0_combout\,
	oe => VCC,
	padio => ww_nLed_o(6));
